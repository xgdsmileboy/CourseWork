...
#statusimgbtn1{ position:absolute; z-index:100; margin-left:-180px; font-size:60px;opacity:0;filter:alpha(opacity=0); margin-top:-5px;} 
	...
	<body background="/images/background.jpg" style="style="background-repeat:no-repeat;">
		
		<div class="navbar navbar-default navbar-fixed-top"
			style="background-color: #B5B5B5" role="navigation">
			<div class="container">
				<div class="navbar-header">
				<a href="#" class="navbar-brand" style="color:white">Friend</a>
				</div>
		...
		<div class="container" id="welcome">
			<div class="tabbale col-md-9 col-md-offset-1">
				<form role="form">
					<div class="form-group">
						<textarea id="content" class="form-control" rows="4" placeholder="Say something..."></textarea>
					</div>
					<div class="text-right">
					<button type="button" class="btn btn-primary" id="statusimgbtn">upload picture</button>
					<button type="button" class="btn btn-primary" id="statusbtn">Send</button>
					</div>
					<div id="statusimgdiv" style="display:none">
						<input type="file"  name="statusimg" id="statusimg"/>
						<input type="hidden" name="statusimgpath" id="statusimgpath"/>
						<img src="" id="statusimgshow" />
					</div>
				</form>
				<h3>Moments</h3>
			...
			<div class="col-md-2">
				...
				<div class="input-group">
				  <input type="text" id="name" class="form-control" placeholder="search somebody">
				  <span class="input-group-addon"><span class="glyphicon glyphicon-search" id="search"></span></span>
				</div>
				
				<div class="list-group" id="searchfriendslist">
				</div>
		...
		%>
		<div style=" position:absolute; left:0; top:0px; width:100%; height:100%; background:red;">
			<div ">
