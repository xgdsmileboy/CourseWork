...
<div id ="templatemo_container">
	...
	<div id="templatemo_topsection"> Admin : Order Management System</div>
	...
	<div id="templatemo_content_section">
		...
		<center> <h1><marquee behavior="alternate" >Welcome to the Admin Order Management System</marquee></h1></center>
	</div>
